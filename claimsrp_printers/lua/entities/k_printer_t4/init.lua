...
local MaxMultiplier = 3.0 -- What is the max amount that the multiplier can be. (Float/Decimal value)
...
local function SetValues( ent )
	...
	ent.minPrint = 14; -- Minimum print amount.
	...
	ent.printerColor = Color( 255, 255, 0, 255 ); -- The color of the printer prop.
